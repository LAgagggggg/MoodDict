...
@interface FrightenViewController ()

@end

@implementation FrightenViewController
...
-(void)setNavigation{
    ...
    UINavigationItem * navigationBarTitle = [[UINavigationItem alloc] initWithTitle:@"恐惧"];

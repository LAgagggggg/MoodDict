...
@interface DisgustViewController ()

@end

@implementation DisgustViewController
...
-(void)setNavigation{
    ...
    UINavigationItem * navigationBarTitle = [[UINavigationItem alloc] initWithTitle:@"厌恶"];

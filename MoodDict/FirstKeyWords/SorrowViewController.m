...
@interface SorrowViewController ()

@end

@implementation SorrowViewController
...
-(void)setNavigation{
    ...
    UINavigationItem * navigationBarTitle = [[UINavigationItem alloc] initWithTitle:@"悲伤"];

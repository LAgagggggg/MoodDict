...
@interface AngerViewController ()

@end

@implementation AngerViewController
...
-(void)setNavigation{
    ...
    UINavigationItem * navigationBarTitle = [[UINavigationItem alloc] initWithTitle:@"愤怒"];

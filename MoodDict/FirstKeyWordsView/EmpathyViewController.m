...
@interface EmpathyViewController ()

@end

@implementation EmpathyViewController
...
-(void)setNavigation{
    ...
    UINavigationItem * navigationBarTitle = [[UINavigationItem alloc] initWithTitle:@"共情"];

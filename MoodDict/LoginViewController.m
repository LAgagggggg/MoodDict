...
-(instancetype)init{
    ...
    //顶部logo
    UIImageView * iconImageView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"我的"]];
    ...
    self.switchUnderLine.backgroundColor=[UIColor darkGrayColor];
    ...
    UIImageView * icon2=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"我的"]];
    ...
    [self.cancelBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.submitBtn.mas_bottom).with.offset(10);
        make.left.equalTo(self.view.mas_left).with.offset(33);
        make.right.equalTo(self.view.mas_right).with.offset(-33);
